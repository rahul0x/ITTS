...
<%
    ...
    String sql1 = "update tourist set t_reserv_status = 'pending' where t_id = '" + name + "'";
    st.executeUpdate(sql1);
    
    String sql = "update reservation set r_status = 'pending' where rt_name = '" + name + "' and r_date = '" + date + "'"   ;
